...
Based on **Sources**, evaluate the classification of LLD actions and the knowledge of action classification.
Then, refine and improve the categorization of GPM classes and the PartOf Relationship, referring to the **Sources** section.
