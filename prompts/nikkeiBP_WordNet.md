...
- [ ] Categorize the gained actions in Step1 by the relationship of **hponymy**, based on WordNet.
...
- [ ] Make a list of groups which have log actions of the same relation of **hponymy**.
